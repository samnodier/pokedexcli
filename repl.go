...
func getCommands() map[string]cliCommand {
	commands := map[string]cliCommand{
		"pokedex": {
			name:        "pokedex",
			description: "List all the names of the Pokemon the user has caught",
		...
		"catch": {
			...
			description: "Catches Pokemon and add them to the user's Pokedex",
			callback:    commandCatch,
		},
		"inspect": {
			name:        "inspect <pokemon_name>",
			description: "Prints name, height, weight, stats and type(s) of the caught Pokemon",
